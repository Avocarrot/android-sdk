...
dependencies {
  compile(name: 'core', version:'4.6.1', ext: 'aar')
  compile(name: 'insights', version:'4.6.1', ext: 'aar')
  compile(name: 'mediation-sdk', version:'4.6.1', ext: 'aar')
  
  //To use Native Assets only 
  compile(name: 'mediation-sdk-native-assets', version:'4.6.1', ext: 'aar')
  
  //To use Banners and Interstitials
  compile(name: 'mediation-sdk-mraid', version:'4.6.1', ext: 'aar')
  ...
  compile(name: 'mediation-applovin', version:'4.6.1', ext: 'aar')
  ...
  compile(name: 'mediation-chartboost', version:'4.6.1', ext: 'aar')
  compile(name: 'mediation-chartboost-interstitial', version:'4.6.1', ext: 'aar')
  compile(name: 'mediation-facebook', version:'4.6.1', ext: 'aar')
  ...
  compile(name: 'mediation-inlocomedia', version:'4.6.1', ext: 'aar')
  ...
  compile(name: 'mediation-mopub', version:'4.6.1', ext: 'aar')
  ...
  compile(name: 'mediation-nativex', version:'4.6.1', ext: 'aar')
  ...
  compile(name: 'mediation-unityads', version:'4.6.1', ext: 'aar')
  compile(name: 'mediation-unityads-video', version:'4.6.1', ext: 'aar'
  compile(name: 'mediation-vungle', version:'4.6.1', ext: 'aar'))
